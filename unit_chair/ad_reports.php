            ...
            <div class="card-body">
                ...
                <div class="table-wrapper">
                    <table class="table table-bordered">
                        ...
                        $total_pages_sql = "SELECT COUNT(*) FROM adviser_logs";
                        ...
                        $sql = "SELECT concat(ad_fname,' ', ad_mname,'. ', ad_lname) ad_name, trans_date, advisers.ad_id, trans_info, concat(chair_fname, ' ' ,chair_mname, ' ' ,chair_lname) chairname
                                    FROM adviser_logs 
                                    LEFT JOIN advisers on advisers.ad_id = adviser_logs.ad_id
                                    LEFT JOIN chair on chair.chair_id = adviser_logs.createdby
                                    GROUP BY advisers.ad_id LIMIT $offset, $no_of_records_per_page
                                ";
