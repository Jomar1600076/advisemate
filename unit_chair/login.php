...
<html lang="en">
<head>
	<title>Advisement Unit Chair</title>
...
<body style="background-color:#fdd835;">
    ...
    <nav class="mb-1 navbar navbar-expand-lg navbar-dark primary-color-dark lighten-1 sticky-top">
            <a class="navbar-brand" href="#">Advisemate Unit Chair</a>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col"></div>
            <div class="col-5">
                <form class="text-center border border-light p-5 white" action="chair_login.php" method="POST">
                    <img src="logo.png" alt="mdb logo" width="100px">
                    <p class="h4 mb-4">Sign in</p>
                    <!-- Email -->
                    <input type="text" id="defaultLoginFormEmail" class="form-control mb-4" name="uChairUname"placeholder="Username">
                    <!-- Password -->
                    <input type="password" id="defaultLoginFormPassword" class="form-control mb-4" name="uChairPword" placeholder="Password">
