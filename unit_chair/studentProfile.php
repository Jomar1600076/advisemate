...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <?php include("../super_admin/StudentAddModal.php") ?>
  </header>
  <!--Main Navigation-->
  ...
  <!--Main layout-->
    ...
    <script>
        ...
        console.log(user_id);
        $(function(){
            $("#student_profile").load("../super_admin1/student_profile_info.php?id="+user_id+"");
            $(this).addClass('active').siblings().removeClass('active');
        });
        ...
        function student_grade(){
            $("#student_profile").load("../super_admin1/student_profile_grade.php?id="+user_id+"");
        }
    </script> 
  </body>
  </html>
