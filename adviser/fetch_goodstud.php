<?php
        ...
        FROM students
        WHERE students.year_lvl = '$yr_lvl' ";
        ...
        //get ave
        $sql = "SELECT grades.id, students.student_id, ROUND( AVG(grade),2) as Avegrade, CONCAT(fname,' ', mname,' ', lname) as fullname, grades.grade, subjects.sub_code
        from subjects
        LEFT JOIN grades on grades.sub_code = subjects.sub_code
        LEFT JOIN students on students.student_id = grades.student_id       
            WHERE students.year_lvl = '$yr_lvl'
